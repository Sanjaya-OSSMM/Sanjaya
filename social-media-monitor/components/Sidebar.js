...
export default function Sidebar({ theme, setTheme, platform, setPlatform }) {
  return (
    <div className="w-64 bg-gray-100 dark:bg-gray-800 p-6 flex flex-col justify-between">
      <div>
        <header className="mb-8">
          <h1 className="text-4xl font-bold text-center" style={{ fontFamily: 'Poppins, sans-serif' }}>
            Sanjaya  🔍
          </h1>
          <h2 className="text-sm font-semibold text-center mt-1" style={{ fontFamily: 'Poppins, sans-serif', margin: '0 auto', width: 'fit-content' }}>
      ...
      <div className="space-y-4">
        ...
        <div className="text-sm text-center mt-1" style={{ fontFamily: 'Poppins, sans-serif' }}>
          <p>Built with ❤️ </p>
